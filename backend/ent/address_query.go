...
func (_q *AddressQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *AddressQuery) FirstIDX(ctx context.Context) string {
...
func (_q *AddressQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *AddressQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *AddressQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *AddressQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
