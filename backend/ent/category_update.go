...
func (_u *CategoryUpdate) AddProductIDs(ids ...string) *CategoryUpdate {
...
func (_u *CategoryUpdate) RemoveProductIDs(ids ...string) *CategoryUpdate {
...
// AddProductIDs adds the "products" edge to the Product entity by IDs.
func (_u *CategoryUpdateOne) AddProductIDs(ids ...string) *CategoryUpdateOne {
	_u.mutation.AddProductIDs(ids...)
	return _u
}
...
// RemoveProductIDs removes the "products" edge to Product entities by IDs.
func (_u *CategoryUpdateOne) RemoveProductIDs(ids ...string) *CategoryUpdateOne {
	_u.mutation.RemoveProductIDs(ids...)
	return _u
}
