...
func (_u *OrderItemUpdate) SetOrderID(id string) *OrderItemUpdate {
...
func (_u *OrderItemUpdate) SetProductID(id string) *OrderItemUpdate {
...
// SetOrderID sets the "order" edge to the Order entity by ID.
func (_u *OrderItemUpdateOne) SetOrderID(id string) *OrderItemUpdateOne {
	_u.mutation.SetOrderID(id)
	return _u
}
...
// SetProductID sets the "product" edge to the Product entity by ID.
func (_u *OrderItemUpdateOne) SetProductID(id string) *OrderItemUpdateOne {
	_u.mutation.SetProductID(id)
	return _u
}
