...
func (_c *ProductCreate) SetSellerID(id string) *ProductCreate {
	_c.mutation.SetSellerID(id)
	return _c
}

// SetSeller sets the "seller" edge to the Seller entity.
func (_c *ProductCreate) SetSeller(v *Seller) *ProductCreate {
	return _c.SetSellerID(v.ID)
}

// SetCategoryID sets the "category" edge to the Category entity by ID.
func (_c *ProductCreate) SetCategoryID(id string) *ProductCreate {
...
func (_c *ProductCreate) AddImageIDs(ids ...string) *ProductCreate {
	_c.mutation.AddImageIDs(ids...)
	return _c
}

// AddImages adds the "images" edges to the ProductImage entity.
func (_c *ProductCreate) AddImages(v ...*ProductImage) *ProductCreate {
...
func (_c *ProductCreate) AddInventoryIDs(ids ...string) *ProductCreate {
	_c.mutation.AddInventoryIDs(ids...)
	return _c
}

// AddInventory adds the "inventory" edges to the Inventory entity.
func (_c *ProductCreate) AddInventory(v ...*Inventory) *ProductCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *ProductCreate) AddOrderItemIDs(ids ...string) *ProductCreate {
...
func (_c *ProductCreate) AddCartItemIDs(ids ...string) *ProductCreate {
	_c.mutation.AddCartItemIDs(ids...)
	return _c
}

// AddCartItems adds the "cart_items" edges to the CartItem entity.
func (_c *ProductCreate) AddCartItems(v ...*CartItem) *ProductCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddCartItemIDs(ids...)
}
...
func (_c *ProductCreate) check() error {
	...
	if len(_c.mutation.SellerIDs()) == 0 {
		return &ValidationError{Name: "seller", err: errors.New(`ent: missing required edge "Product.seller"`)}
	}
...
func (_c *ProductCreate) createSpec() (*Product, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.CartItemsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
