...
import { Truck, MapPin, DollarSign, Clock, Star, Phone, Navigation } from "lucide-react"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div className="flex items-center justify-between px-2">
              <h3 className="font-black text-2xl text-slate-800">Próxima Entrega</h3>
              <Badge className="bg-brand-coral/10 text-brand-coral border-0 py-1.5 px-4 rounded-full font-bold">Urgente</Badge>
            </div>
            
            <Card className="border-0 shadow-xl bg-white rounded-[3rem] p-2 hover:translate-y-[-4px] transition-all">
              <CardContent className="p-8">
                <div className="flex items-start justify-between mb-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-xl font-black text-slate-800">Big Burger Centro</div>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-2xl font-black text-brand-teal">R$ 12,50</div>
                    <div className="text-[10px] font-bold text-slate-400 uppercase">Valor da taxa</div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Button variant="outline" className="h-16 rounded-[1.5rem] border-slate-100 text-slate-600 font-bold hover:bg-slate-50 flex gap-2">
                    <Phone className="w-4 h-4" /> Ligar
                  </Button>
                  <Button className="h-16 rounded-[1.5rem] bg-brand-teal text-white font-bold hover:bg-brand-teal/90 shadow-lg shadow-brand-teal/20 flex gap-2">
